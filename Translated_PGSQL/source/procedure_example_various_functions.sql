CREATE OR REPLACE PROCEDURE prajwal_test.ExampleProcedure(
in_empid INT64,
...
INSERT INTO prajwal_test.EmployeeInfo (EmpID, EmpFname, EmpLname, Department, Project, Address, DOB, Gender)
...
INSERT INTO prajwal_test.EmployeePosition (EmpID, EmpPosition, DateOfJoining, Salary)
