CREATE OR REPLACE PROCEDURE prajwal_test.TRUNCATE_TABLE(TEMP_TABLE_NAME STRING, TEMP_TABLE_NAME2 STRING)
                            ...
                            BEGIN
                            EXECUTE IMMEDIATE CONCAT('TRUNCATE TABLE `mlconsole-poc.prajwal_test.', TEMP_TABLE_NAME, '`');
                            EXECUTE IMMEDIATE CONCAT('TRUNCATE TABLE `mlconsole-poc.prajwal_test.', TEMP_TABLE_NAME2, '`');
