CREATE OR REPLACE PROCEDURE exampleprocedure(
    in_empid integer,
    in_empfname character varying(50),
    in_emplname character varying(50),
    in_department character varying(50),
    in_project character varying(50),
    in_address character varying(100),
    in_dob timestamp,
    in_gender character varying(20) DEFAULT 'M',
    in_empposition character varying(50),
